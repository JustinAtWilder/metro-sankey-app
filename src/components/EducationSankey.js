...
import { educationData } from "../data/educationData"; // Import the data

const EducationSankey = () => {
  useEffect(() => {
    ...
    if (graphDiv) {
      ...
      const updatePlot = () => {
        ...
        Plotly.react(graphDiv, [educationData], layout, {displayModeBar: false});
      };
...
export default EducationSankey;