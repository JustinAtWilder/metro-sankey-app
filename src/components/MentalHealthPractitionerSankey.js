...
import { mentalhealthData } from "../data/mentalhealthData"; // Import the data

const MentalHealthPractitionerSankey = () => {
  useEffect(() => {
    ...
    if (graphDiv) {
      ...
      const updatePlot = () => {
        ...
        Plotly.react(graphDiv, [mentalhealthData], layout, {displayModeBar: false});
      };
...
export default MentalHealthPractitionerSankey;