    ...
    if (chartRef.current) {
      ...
      chartInstance.current = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            data: [64000, 65200, 66100, 66800, 67400, 68044, 68402, 68760, 69118, 69476, 70193, 70552, 70910, 71268, 71450, 71631],
            borderColor: '#0087a9',
  ...
  return (
    <div className={styles.container}>
      <div className={styles.chartContainer}>
        ...
        <div className={styles.chartSubtitle}>Registered Nurses</div>
        <canvas ref={chartRef}></canvas>
        <div className={styles.stats}>
          <div className={styles.stat}>
            <div className={styles.statLabel}>2020-2030 Growth</div>
            <div className={styles.statValue}>+5.3%</div>
          </div>
          <div className={styles.stat}>
            <div className={styles.statLabel}>Annual Openings</div>
            <div className={styles.statValue}>~2,677</div>
          </div>
          <div className={styles.stat}>
            <div className={styles.statLabel}>Median Wage</div>
            <div className={styles.statValue}>$41.96/hr</div>
          </div>
        </div>
      </div>
    </div>
